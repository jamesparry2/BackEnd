                    ...
                    <ul class = "nav navbar-nav">
                        ...
                        <li class = "dropdown">
                            ...
                            <ul class = "dropdown-menu">
                                ...
                                <li class = "active"><a href = "">Section 3.2: Encapsulation </a></li> <!-- Removed Contents from other pages !-->
                            </ul>    
                        </li>
                        <li style = "padding-right: 100px;" class = "dropdown">
                            ...
                            <ul class = "dropdown-menu">
                                ...
                                <li><a href = "Inheritance.php">Section 1.2: Polymorphism and Examples </a></li><!-- Add Polyorphism here to other sections !-->
                                <li role = "separator" class = "divider"></li>
    ...
    <div class = "step_section">
        ...
        <br/>
            ...
            ?>
                ...
                <p><button onClick = "DisplayQuestion('ooSection')">Question Time!</button></p>
